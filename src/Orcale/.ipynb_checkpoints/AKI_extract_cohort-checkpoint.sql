...
create table AKI_EXCLD_L1GFR_EN as
...
-- Pre-existing ESRD
create table AKI_EXCLD_PRF_EN as
...
create table AKI_EXCLD_PRRT_EN_DX as 
select aki.ENCOUNTERID
       , dx.DX_TYPE
       , dx.DX
       , dx.ADMIT_DATE
...
create table AKI_EXCLD_PRRT_EN_PX as 
select aki.ENCOUNTERID
       , px.PX_TYPE
       , px.px
       , px.PX_DATE
...
create table AKI_EXCLD_PRRT_EN as 
select * from AKI_EXCLD_PRRT_EN_DX 
union all
select * from AKI_EXCLD_PRRT_EN_PX 
;

-- Receive renal transplant withing 48 hr since 1st Scr (PX, DX)
create table scr48 as 
...
create table AKI_EXCLD_RT48_EN as
...
-- Burn Patients
create table AKI_EXCLD_BURN_EN as
...
select distinct
      ...
      ,ADMIT_DATE
      ,to_char(trunc(ADMIT_DATE),'YYYY') ADMIT_YEAR
      ,DISCHARGE_DATE
      ,SERUM_CREAT_BASE
      ,NONAKI_ANCHOR
      ,NONAKI_SINCE_ADMIT
...
/*************************
 Consort Diagram
***************************/
create table consort_diagram_BC as
...
--drop table AKI3_RRT purge;
--drop table AKI_ELIGIBLE purge;
--drop table AKI_EXCLD_BURN_EN purge;
--drop table AKI_EXCLD_L1GFR_EN purge;
--drop table AKI_EXCLD_PRF_EN purge;
--drop table AKI_EXCLD_PRRT_EN purge;
--drop table AKI_EXCLD_PRRT_EN_DX purge;
--drop table AKI_EXCLD_PRRT_EN_PX purge;
--drop table AKI_EXCLD_RT48_EN purge;
--drop table AKI_INIT purge;
--drop table AKI_Initial purge;
--drop table AKI_Scr_base purge;
--drop table AKI_Scr_eGFR purge;
--drop table AKI_STAGES purge;
--drop table AKI_STAGES_DAILY purge;
--drop table All_Scr_eGFR purge;
--drop table EXCLUDE_ALL purge;
--drop table SCR48 purge;
--drop table STAGE_AKI purge;
--drop table STAGE_UNI purge;