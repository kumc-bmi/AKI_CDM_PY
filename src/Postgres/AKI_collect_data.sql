...
where v.obsclin_start_date between (pat.ADMIT_DATE - INTERVAL '30 DAYS') and coalesce(pat.AKI3_ONSET,pat.AKI2_ONSET,pat.AKI1_ONSET,pat.NONAKI_ANCHOR,pat.DISCHARGE_DATE) --and
...
from GPC_aki_project.AKI_onsets pat
join &&cdm_db_schema.LAB_RESULT_CM l
on pat.PATID = l.PATID and l.LAB_ORDER_DATE between (pat.ADMIT_DATE - INTERVAL '365 DAYS') and least(coalesce(pat.AKI3_ONSET,pat.AKI2_ONSET,pat.AKI1_ONSET,pat.NONAKI_ANCHOR,pat.DISCHARGE_DATE),pat.DISCHARGE_DATE)
